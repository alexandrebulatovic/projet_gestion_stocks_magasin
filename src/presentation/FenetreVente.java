 ...
 * il veut enregistrer une vente pour mettre à jour le stock d'un produit.
 */
...
public class FenetreVente extends JFrame implements ActionListener {
	...
	public FenetreVente(ControleurCatalogue controleurCatalogue, String[] produits) {
		...
		JButton btVente = new JButton("Vente");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (this.controleur_catalogue.vendreStock(nomProduit, quantite))
